      ...
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Description de  ""</h5>
            ...
            <div class="row p-6 pt-2">
              ...
              <div class="card">
                <div class="card-header  bg-gradient-primary">
                  <h3 class="card-title flex-grow-1"> <i class="fas fa-tasks"></i> <span class="badge rounded-pill bg-warning">a</span> </h3>
